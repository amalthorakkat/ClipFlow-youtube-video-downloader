...
const LinkPaste = ({ onDownload }) => {
  ...
  const handleDownload = (formatUrl, title) => {
    ...
    // link.href = `https://clipflow-youtube-video-downloader.onrender.com/api/proxy?url=${formatUrl}`;
...
// const LinkPaste = ({ onDownload }) => {
//   const { t } = useTranslation("translation"); // Fixed: Use "translation" namespace
//   const [url, setUrl] = useState("");
//   const [mediaInfo, setMediaInfo] = useState(null);
//   const [isLoading, setIsLoading] = useState(false);
//   const [isVisible, setIsVisible] = useState(false);
...
//   const handleDownload = (formatUrl, title, mimeType) => {
//     setIsExiting(true);
//     const link = document.createElement("a");
//     link.href = `https://clipflow-youtube-video-downloader.onrender.com/api/proxy?url=${encodeURIComponent(
//       formatUrl
//     )}&title=${encodeURIComponent(title)}`;
//     link.download = `${title.replace(/[^a-zA-Z0-9]/g, "_")}${
